...
class BranchBin(batchstep.BatchStep):
    ...
    def run_step(self):
        ...
        self.branch_binned2 = self.hit_list_expanded.groupby(['Branch #'])['IA Risk Score'].sum().reset_index()
        ...
        self.branch_binned2.to_sql('branch_binned2', con = engine, if_exists = 'replace',index = False, chunksize = 1000)
        ...
        pickle.dump(self.branch_binned2, open(self.pickled_dir + '/branch_binned2.pkl', 'wb'))
