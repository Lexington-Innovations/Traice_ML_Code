...
​        """
        ...
        self.df_ia_agg_scored.iloc[:,:24].to_sql('df_ia_agg_scored', con = engine, if_exists = 'replace', chunksize = 1000)
        self.df_ia_agg_scored.to_csv(self.pickled_dir + '/df_ia_agg_scored.csv', encoding='utf-8')
